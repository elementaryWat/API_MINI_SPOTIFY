...
routerUser.post("/passwordEqual",md_auth.ensureAuth,userController.passwordEqual);
routerUser.put("/updatePassword/:userId",md_auth.ensureAuth,userController.actualizarPassword);
